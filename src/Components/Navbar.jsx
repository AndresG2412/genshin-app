...
export default function Navbar() {
    return(
        <div 
            className="shadowwhite fixed top-6 left-1/2 -translate-x-1/2 hidden md:flex w-2/4 h-auto justify-between items-center font-semibold text-2xl py-4 px-12 rounded-xl backnavbar shadow-2xl text-white tracking-widest">
